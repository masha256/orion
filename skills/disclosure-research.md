...
- You cannot record a figure where an observation already exists at the same metric and date. If the existing one is wrong, propose rejecting it and say why; do not look for a nearby date to write around it.
